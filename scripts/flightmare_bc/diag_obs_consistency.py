...
def _env_kwargs(cfg: Config) -> dict:
    ...
    keys = {
        ...
        "gate_yaw_noise", "gate_size", "z_min", "gate_vehicle_radius",
        ...
        "reset_mode", "start_gate_index", "start_gate_choices",
        "start_offset_m", "start_offset_range", "reference_speed_mps",
        "goal_mode", "goal_gate_span",
    }
